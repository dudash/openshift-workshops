...
<p><img alt="OpenShift Scaling Pods" src="{{ site.baseurl }}/images/oseoffline-lab-replicationrecovery-4pods.png" width="500"/></p>
...
<p><img alt="OpenShift List Pods" src="{{ site.baseurl }}/images/oseoffline-lab-replicationrecovery-4podslist.png" width="500"/></p>
...
<p><img alt="OpenShift Delete Pod" src="{{ site.baseurl }}/images/oseoffline-lab-replicationrecovery-deletepod.png" width="400"/></p>
...
<p><img alt="OpenShift Recover Pod Automatically" src="{{ site.baseurl }}/images/oseoffline-lab-replicationrecovery-podrecovery.png" width="600"/></p>
...
<p><img alt="OpenShift Process Kill Node Terminal Command" src="{{ site.baseurl }}/images/oseoffline-lab-replicationrecovery-terminal.png" width="400"/></p>

This will kick you out off the container with an error like "error: error executing remote command".

<p><img alt="OpenShift Process Kill Node Terminal Kick" src="{{ site.baseurl }}/images/oseoffline-lab-replicationrecovery-terminalkick.png" width="400"/></p>
...
<p><img alt="OpenShift Replication Controller Backoff Autorecovery" src="{{ site.baseurl }}/images/oseoffline-lab-replicationrecovery-backoff.png" width="500"/></p>
