...
<p><img alt="Open Shift All Pods" src="{{ site.baseurl }}/images/oseoffline-lab-labels-allpods.png" width="500"/></p>
Next let's look at the log for the pod running our application.

<blockquote>
Click the pod for the webapp (it shoud have a status of Running)
</blockquote>
<p><img alt="OpenShift Pod Details" src="{{ site.baseurl }}/images/oseoffline-lab-labels-poddetails.png" width="500"/></p>
Here, at the top, you can see the labels on this pod

<blockquote>
Click vertically stacked "..." button, then click "Edit" the pod
</blockquote>
<p><img alt="OpenShift Pod Edit" src="{{ site.baseurl }}/images/oseoffline-lab-labels-podedit.png" width="500"/></p>
