...
<p><img src="{{ site.baseurl }}/images/ose-lab-s2i-addbutton.png" width="100"/></p>

<blockquote>
Click "Browse" and filter for nodejs, then click the nodejs:0.10 builder image
</blockquote>
<p><img src="{{ site.baseurl }}/images/ose-lab-s2i-filternode.png" width="600"/></p>

<blockquote>
Fill out the boxes to look as follows:
</blockquote>
<p><img src="{{ site.baseurl }}/images/ose-lab-s2i-addtoproject.png" width="600"/></p>
<p>
...
<p><img src="{{ site.baseurl }}/images/ose-lab-s2i-builds.png" width="300"/></p>

<blockquote>
Click on the "dc-metro-map" link
</blockquote>
<p><img src="{{ site.baseurl }}/images/ose-lab-s2i-metromapbuild.png" width="300"/></p>

<blockquote>
Click on the "View Log" tab to see the details of your latest build
</blockquote>
<p><img src="{{ site.baseurl }}/images/ose-lab-s2i-metromapbuilds.png" width="500"/></p>

You should see a log output similar to the one below:
<p><img src="{{ site.baseurl }}/images/ose-lab-s2i-metromapbuildlog.png" width="500"/></p>
...
<p><img src="{{ site.baseurl }}/images/ose-lab-s2i-overview.png" width="100"/></p>

<blockquote>
Click the URL that is listed in the dc-metro-map service
</blockquote>
<p><img src="{{ site.baseurl }}/images/ose-lab-s2i-dcmetromapsvc.png" width="500"/></p>
...
<p><img src="{{ site.baseurl }}/images/ose-lab-s2i-apprunning.png" width="500"/></p>
