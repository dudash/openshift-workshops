...
<p><img alt="OpenShift Labs GitHub Fork" src="{{ site.baseurl }}/images/ose-lab-rollbacks-fork.png" width="400"/></p>
...
<p><img alt="OpenShift Build Configuration Summary" src="{{ site.baseurl }}/images/ose-lab-rollbacks-buildconfigsummary.png" width="500"/></p>
...
<p><img alt="OpenShift Gogs - Go Git Service - Settings" src="{{ site.baseurl }}/images/ose-lab-rollbacks-settings.png" width="400"/></p>
...
<p><img alt="OpenShift Webhooks and Services" src="{{ site.baseurl }}/images/ose-lab-rollbacks-githubwebhooks.png" width="600"/></p>
...
<p><img alt="OpenShift Add GitHub Webhook" src="{{ site.baseurl }}/images/ose-lab-rollbacks-githubwebhooks-add.png" width="600"/></p>
...
<p><img alt="OpenShift Deployment Configuration Summary" src="{{ site.baseurl }}/images/ose-lab-rollbacks-deploymentconfigsummary.png" width="600"/></p>

<blockquote>
In the Deployments table click the #1
</blockquote>
<p><img alt="OpenShift Deployment Configuration #1" src="{{ site.baseurl }}/images/ose-lab-rollbacks-deploymentconfig1.png" width="500"/></p>
